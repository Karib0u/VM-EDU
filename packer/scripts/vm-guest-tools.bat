if not exist "C:\Windows\Temp\7z2301-x64.msi" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://www.7-zip.org/a/7z2301-x64.msi', 'C:\Windows\Temp\7z2301-x64.msi')" <NUL
)
if not exist "C:\Windows\Temp\7z2301-x64.msi" (
    powershell -Command "Start-Sleep 5 ; (New-Object System.Net.WebClient).DownloadFile('https://www.7-zip.org/a/7z2301-x64.msi', 'C:\Windows\Temp\7z2301-x64.msi')" <NUL
)
...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://download.virtualbox.org/virtualbox/7.0.12/VBoxGuestAdditions_7.0.12.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
